...
cmprssd_folder = os.path.join(src_folder, 'compressed/') # Pasta dos arquivos comprimidos
dcmprssd_folder = os.path.join(src_folder, 'decompressed/') # Pasta dos arquivos descomprimidos
